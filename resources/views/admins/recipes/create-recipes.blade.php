...
<div class="content-wrapper">
    <form method="POST" action="{{ route('store_recipe') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-8">
                <h3>Tên món:</h3>
                <input type="text" name="title" class="form-control mb-3" placeholder="Món canh bí ngon nhất nhà mình" required>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="text" name="servings" class="form-control" placeholder="2 người" required>
            </div>
            <div class="col-md-6">
                <label>Thời gian nấu:</label>
                <input type="text" name="cook_time" class="form-control" placeholder="1 tiếng 30 phút" required>
            </div>
        </div>
        ...
        <div id="ingredients-list">
            <div class="row ingredient-group mb-2">
                <div class="col-md-10">
                    <input type="text" name="ingredients[]" class="form-control" placeholder="250g bột" required>
                </div>
                <div class="col-md-2">
